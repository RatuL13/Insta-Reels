                            ...
                            <React.Fragment key={post.postId}>
                                <div className='videos'>
                                    <Card className={classes.root} style={{border: "1px solid #dfe6e9"}}>
                                                    ...
                                                    <hr style={{ border: "none", height: "-0.1px", color: "#dfe6e9", backgroundColor: "#dfe6e9" }} />
                                ...
                                <div className='place' style={{backgroundImage: "linear-gradient(135deg, rgb(255, 248, 134) 10%, rgb(240, 114, 182) 100%"}}></div>
                            </React.Fragment>
                        ))
                    }
                </div>
